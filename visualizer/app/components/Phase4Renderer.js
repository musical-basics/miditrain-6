...
// ===== Phase 4: Quantize + Notation Rendering =====
// 'phase4a' → quantized piano roll (notes snapped to the Phase 3 grid)
// 'phase4b' → VexFlow notation (rendered by NotationView, not the canvas)
 ...
 */
export function getPhase4NoteColor(n) {
 ...
 */
export function Phase4QuantizeLegend({ gridData }) {
  return (
    <>
      <h3>Phase 4A -- Micro-Quantize</h3>
 ...
 */
export function Phase4NotationLegend({ notationData }) {
  return (
    <>
      <h3>Phase 4B -- Notation Map</h3>
